...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PUZZLEBOX.CloudStorage", b =>
                {
                    b.Property<int>("CloudStorageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CloudStorageId"));

                    b.Property<int>("AccountId")
                        .HasColumnType("int");

                    b.Property<bool>("CloudAutoupload")
                        .HasColumnType("bit");

                    b.Property<byte[]>("CloudCfgZip")
                        .HasColumnType("varbinary(max)");

                    b.Property<string>("FileModifyTime")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("UseCloud")
                        .HasColumnType("bit");

                    b.HasKey("CloudStorageId");
            ...
            modelBuilder.Entity("PUZZLEBOX.CloudStorage", b =>
                {
                    b.HasOne("PUZZLEBOX.Account", null)
                        .WithOne("CloudStorage")
                        .HasForeignKey("PUZZLEBOX.CloudStorage", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
